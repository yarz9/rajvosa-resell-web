...
export const PRODUCTS = [
  ...
  },
  {
    ...
    sizes: SIZES_SHOES,
    description: 'Authenticated. Reverse Swoosh in olive, deadstock with original box and accessories.',
    featured: true,
    tags: ['grail', 'authenticated'],
  },
  {
...
export const BRANDS = [
  ...
  { slug: 'football',    name: 'Football Jerseys',  tagline: 'Authentic Match-Day Kits' },
]
